package com.example.usuario.palette;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgImagen.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.agh9e));

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.agh9e);
            ...
            public void onGenerated(Palette p) {
                ...
                */
                ...
                for (Palette.Swatch sw : p.getSwatches()) {
                    Log.i("Palette", "Color: #" + Integer.toHexString(sw.getRgb()) +
                            " (" + sw.getPopulation() + " píxeles)");
                }
            }
        });
    }
